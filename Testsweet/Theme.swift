...
class Themes: ObservableObject {
    ...
    func getGradient() -> Array<Color>{
        if currentTheme == 0{
            return [Color(#colorLiteral(red: 0.09433246404, green: 0.3047628701, blue: 0.4649187326, alpha: 1)),Color(#colorLiteral(red: 0.1185745522, green: 0.3756733537, blue: 0.5679591298, alpha: 1)),Color(#colorLiteral(red: 0.1607481241, green: 0.5125916004, blue: 0.5261992216, alpha: 1)),Color(#colorLiteral(red: 0.162745297, green: 0.5202785134, blue: 0.5380410552, alpha: 1)),Color(#colorLiteral(red: 0.2764765024, green: 0.6270785928, blue: 0.5273578763, alpha: 1)),Color(#colorLiteral(red: 0.4004970789, green: 0.6831317544, blue: 0.5014337301, alpha: 1)),Color(#colorLiteral(red: 0.5550227761, green: 0.791927278, blue: 0.5073714256, alpha: 1)),Color(#colorLiteral(red: 0.6706730127, green: 0.845440805, blue: 0.5175511241, alpha: 1)),Color(#colorLiteral(red: 0.7970537543, green: 0.8742372394, blue: 0.5379388928, alpha: 1))]
        }
        if currentTheme == 1{
        ...
        if currentTheme == 4{
            return [Color(#colorLiteral(red: 0.9553784728, green: 0.09136072546, blue: 0.3287055492, alpha: 1)),Color(#colorLiteral(red: 0.9666003585, green: 0.2778905332, blue: 0.4963815808, alpha: 1)),Color(#colorLiteral(red: 0.968077004, green: 0.3583317697, blue: 0.543836534, alpha: 1)),Color(#colorLiteral(red: 0.9803705812, green: 0.6950640678, blue: 0.7403133512, alpha: 1)),Color(#colorLiteral(red: 0.9766011834, green: 0.7450146079, blue: 0.7800876498, alpha: 1))]
        }
        if currentTheme == 5{
            return [Color(#colorLiteral(red: 0.8489733934, green: 0.07412941009, blue: 0.3481240273, alpha: 1)),Color(#colorLiteral(red: 0.5600893497, green: 0.1756859124, blue: 0.3387384415, alpha: 1)),Color(#colorLiteral(red: 0.1402911842, green: 0.5127117038, blue: 0.5016019344, alpha: 1)),Color(#colorLiteral(red: 0.4497362375, green: 0.8245891929, blue: 0.8723714948, alpha: 1))]
        }
        return regularTheme
    }
